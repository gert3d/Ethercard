...
// 
// Tsensor in function gebracht, maar in html pag wordt 2x de pointer naar char[] opgehaald, en -dus- laat alleen de laatste 2x zien. Moet op een andere manier..
...
//  ds1820(0);
//  ds1820(1);
  bfill.emit_p(PSTR("$F"                                //$F represents a string, $D represents word or byte, $S represents char[].
    "<meta http-equiv='refresh' content='5'/>"
    "<title>Ethercard interface</title>" 
    "Temperature sensor-0 is $S degrees Celcius<br>"   
    "<p>TricolorLED is <a href=\"?led=$F\">$F</a> -> "
   "varying LDR voltage is $S <br><p>"
    "Heating resistor is <a href=\"?led2=$F\">$F</a> -> "
